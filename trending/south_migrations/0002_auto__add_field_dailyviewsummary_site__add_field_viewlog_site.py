...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('trending_dailyviewsummary', 'site_id')

        # Deleting field 'ViewLog.site'
        db.delete_column('trending_viewlog', 'site_id')
