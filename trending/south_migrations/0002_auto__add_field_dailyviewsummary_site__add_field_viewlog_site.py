...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DailyViewSummary.site'
        db.add_column(u'trending_dailyviewsummary', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'ViewLog.site'
        db.add_column(u'trending_viewlog', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DailyViewSummary.site'
        db.delete_column(u'trending_dailyviewsummary', 'site_id')

        # Deleting field 'ViewLog.site'
        db.delete_column(u'trending_viewlog', 'site_id')
